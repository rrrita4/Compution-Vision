	...
	if ( G->what_segment(nodes[ nodex-1 ] ) == Graph::SOURCE ) {
	  ...
	  if (!lastSource) {
		  ...
		  seav[x * t_height + y][3] = (*img_out)(x, y - 1, 2);}
			  ...
			  seav[x * t_height + y][1] = (*img_out)(x, y, 0);
			  seav[x * t_height + y][2] = (*img_out)(x, y, 1);
			  seav[x * t_height + y][3] = (*img_out)(x, y, 2);
		  }
	    ...
	    if ( G->what_segment( nodes[ (*img_msk)( xx, yy ) - 1 ] ) == Graph::SINK ) {
	      ...
	      seah[ x*t_height + y ][3] = (*img_out)( x-1, y, 2 );}
			  ...
			  seah[x * t_height + y][1] = (*img_out)(x, y, 0);
			  seah[x * t_height + y][2] = (*img_out)(x, y, 1);
			  seah[x * t_height + y][3] = (*img_out)(x, y, 2);
		  }
	...
	/* superposition => do not nb_pixels++ */
	  ...
	  if ( lastSource ) {
		...
		if (y) {
			...
			seav[x * t_height + y][4] = (*img_out)(x, y, 0);
			seav[x * t_height + y][5] = (*img_out)(x, y, 1);
			seav[x * t_height + y][6] = (*img_out)(x, y, 2);
		}
	    ...
	    if ( G->what_segment( nodes[ (*img_msk)( xx, yy ) - 1 ] ) == Graph::SOURCE ) {
		  ...
		  if (x) {
			  ...
			  seah[x * t_height + y][4] = (*img_out)(x, y, 0);
			  seah[x * t_height + y][5] = (*img_out)(x, y, 1);
			  seah[x * t_height + y][6] = (*img_out)(x, y, 2);
		  }
